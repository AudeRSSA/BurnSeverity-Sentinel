...
shpx <- st_read("M:\\zdrive\\DEC\\Prescribed_Bushfire_Outcomes_2018-134\\DATA\\Working\\Sentinel\\xIndex\\DBCA_FireHistory_2017-2023_Id.shp", quiet = TRUE) %>%
...
shp.tmp <- st_read("M:\\zdrive\\DEC\\Prescribed_Bushfire_Outcomes_2018-134\\DATA\\Working\\Sentinel\\xModels\\Template_AFED\\Template_AFED.shp")
shp.tmp[1,1] <- NA
